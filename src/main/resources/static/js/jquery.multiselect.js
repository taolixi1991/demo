...
(function($, undefined) {
    ...
    $.widget("ech.multiselect", {
         ...
         * Causes the option to also update its cache if the option is loaded
         */
        _updateCache: function() {
            ...
            this.$labels = this.$menu.find('label:not(.ui-multiselect-option-label)');
            this.$inputs = this.$labels.children('input');

            // If the option widget is in use, then also update its cache.
                ...
                switch(e.which) {
                    ...
                    case 9: //tab
                        ...
                        if ((e.shiftKey
                            ...
                            && !self.$header.find(".ui-multiselect-option").length)
        ...
        open: function() {
            ...
            // focus the first not disabled option or option input if available
            var filter = $header.find(".ui-multiselect-option");
            if (filter.length) {
